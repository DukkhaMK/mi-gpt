...
export default {
  ...
  speaker: {
    ...
    password: "123456",
    // 小爱音箱 DID 或在米家中设置的名称
    did: "小爱音箱 mini", // 注意空格、大小写和错别字（音响 👉 音箱）
    ...
    callAIKeywords: ["请", "你", "无根生"],
    // 当消息以下面的关键词开头时，会进入 AI 唤醒状态
    wakeUpKeywords: ["打开", "进入", "召唤"],
    // 当消息以下面的关键词开头时，会退出 AI 唤醒状态
    exitKeywords: ["关闭", "退出", "再见"],
    // 进入 AI 模式的欢迎语
    onEnterAI: ["朋友，找我何事"], // 设为空数组时可关闭提示语
    // 退出 AI 模式的提示语
    onExitAI: ["既然阁下没事儿，我就先撤了"], // 为空时可关闭提示语
    // AI 开始回答时的提示语
    onAIAsking: ["容我想想", "你等会儿"], // 为空时可关闭提示语
    // AI 结束回答时的提示语
    onAIReplied: ["我说完了", "您还有别的事儿吗"], // 为空时可关闭提示语
    // AI 回答异常时的提示语
    onAIError: ["啊哈，报错了，一会儿再试吧！"], // 为空时可关闭提示语
